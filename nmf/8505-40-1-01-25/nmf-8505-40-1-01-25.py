...
df = pandas.read_csv('~/Code/tedtalks/data/talks_3a.csv', names=colnames)
talks = df.text.tolist()

# Import stoplist
stopwords = re.split('\s+', open('/Users/john/Code/tedtalks/data/stopwords_2.txt', 'r').read().lower())
...
np.savetxt("8505-40-1-01-25-dtm.csv", H, delimiter=",", fmt = "%s")
np.savetxt("8505-40-1-01-25-twm.csv", W, delimiter=",", fmt = "%s")
