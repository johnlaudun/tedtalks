...
# Import stoplist
stopwords = re.split('\s+', open('/Users/jjl5766/Code//tedtalks/data/stopwords_2.txt', 'r').read().lower())
...
np.savetxt("8505-40-1-01-10-dtm.csv", H, delimiter=",", fmt = "%s")
np.savetxt("8505-40-1-01-10-twm.csv", W, delimiter=",", fmt = "%s")
