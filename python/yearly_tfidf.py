...
file_out = f'../output/yearly-tfidf-min{min_years}_max{max_years}.csv'
...
term_matrix = pd.DataFrame( X.todense(), 
...
print(f'==> CSV created of TF-IDF matrix with {term_df.shape} shape.')