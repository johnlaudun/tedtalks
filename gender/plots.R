library(ggplot2)
df <- read.csv("../output/tfidf_ajbc.csv")
...
ggsave("../output/i_subjects.pdf", width=6, height = 45, units="in")
...
ggsave("../output/he_subjects.pdf", width=6, height = 30, units="in")
...
ggsave("../output/she_subjects.pdf", width=6, height = 25, units="in")